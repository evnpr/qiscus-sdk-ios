...
public class QComment:Object {
    ...
    // file variable
    @objc public dynamic var isDownloading = false
    @objc public dynamic var isUploading = false
    ...
    public func updateCellPos(cellPos: QCellPosition){
        ...
        if self.cellPos != cellPos {
            ...
            func execute(){
                print("[QISCUS QComment 655] CellPostion =\(String(describing: QComment.cache[uId]?.cellPos))")
